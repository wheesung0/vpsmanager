...
wget -O /bin/rebootnb https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/ArchivosUtilitarios/resetsshdrop &> /dev/null
...
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/Version &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Kalix1 ❌\033[1;33m ]"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "Code de KEY Invalido!") ]]; then
   ...
   wget -O $HOME/systemverify https://raw.githubusercontent.com/wheesung0/vpsmanager/main/Install/systemverify &> /dev/null
